        ...
        <div className="p-10 space-y-6">
          ...
          <div className="space-y-4">
            {MOCK_USERS.map((user) => (
              ...
              >
                <div className="w-10 h-10 bg-white group-hover:bg-cyan-500/20 rounded-lg flex items-center justify-center text-slate-600 group-hover:text-white transition-colors">👤</div>
                <div>
